...
public class UnitGroupSequenceDao extends GroupSequenceDao implements TddlRouterUnitsListener {
    ...
    public void doInit() throws TddlException {
        ...
        RouterHelper.registerUnitsListener(this);
    ...
    public int getUnitcount() {
        Set<String> allUnits = RouterHelper.getUnits();
    ...
    public int getUnitindex() throws SequenceException {
        // not unit
        Set<String> units = RouterHelper.getUnits();
        ...
        // not unit
        String currentUnit = RouterHelper.getCurrentUnit();
        if (currentUnit == null) {
            return -1;
        }
